...
{ 
    public class DeleteBankClosureSetupCommandHandler : IRequestHandler<DeleteBankClosureSetupCommand, Banking.Contracts.Response.Deposit.DeleteRespObj>
    {
        ...
        public async Task<Banking.Contracts.Response.Deposit.DeleteRespObj> Handle(DeleteBankClosureSetupCommand request, CancellationToken cancellationToken)
        {
