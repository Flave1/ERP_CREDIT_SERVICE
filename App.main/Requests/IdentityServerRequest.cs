...
namespace Banking.Requests
{
    public class IdentityServerRequest : IIdentityServerRequest
    {
        ...
        public async Task<CommonRespObj> GetAllDocumentsAsync()
        {
            try
            {
                var gosGatewayClient = _httpClientFactory.CreateClient("GOSDEFAULTGATEWAY");
                ...
                var result = await gosGatewayClient.GetAsync(ApiRoutes.Currency.DOCUMENT_TYPE);
        ...
        public async Task<CommonRespObj> GetCurrencyAsync()
        {
            ...
            responseObj = Response.Convert<CommonRespObj>(await _cacheService.GetCacheResponseAsync(CacheKeys.common_currencies));
            if (responseObj != null)
                return responseObj;
        ...
        public async Task<CommonRespObj> GetTitleAsync()
        {
            try
            {
                CommonRespObj responseObj = new CommonRespObj();
                ...
                await _retryPolicy.ExecuteAsync(async () =>
                {
                    try
                    {
                        result = await gosGatewayClient.GetAsync(ApiRoutes.Currency.GET_ALL_TITLE);
                        var data = await result.Content.ReadAsStringAsync();
                        responseObj = JsonConvert.DeserializeObject<CommonRespObj>(data);
                    }
                    catch (Exception ex)
        ...
        public async Task<CommonRespObj> GetCitiesAsync()
        {
            try
            {
                CommonRespObj responseObj = new CommonRespObj();
                ...
                await _retryPolicy.ExecuteAsync(async () =>
                {
                    try
                    {
                        result = await gosGatewayClient.GetAsync(ApiRoutes.Currency.GET_ALL_CITIES);
                        var data = await result.Content.ReadAsStringAsync();
                        responseObj = JsonConvert.DeserializeObject<CommonRespObj>(data);
                    }
                    catch (Exception ex)
        ...
        public async Task<CommonRespObj> GetCountriesAsync()
        {
            CommonRespObj responseObj = new CommonRespObj();
            responseObj = Response.Convert<CommonRespObj>(await _cacheService.GetCacheResponseAsync(CacheKeys.common_countries));
            if (responseObj != null)
                return responseObj;
            try
            {
                ...
                await _retryPolicy.ExecuteAsync(async () =>
                {
                    try
                    {
                        result = await gosGatewayClient.GetAsync(ApiRoutes.Currency.GET_ALL_COUNTRIES);
                        var data = await result.Content.ReadAsStringAsync();
                        responseObj = JsonConvert.DeserializeObject<CommonRespObj>(data);
                    }
                    catch (Exception ex)
        ...
        {
            var responseObj = new StaffRespObj();
            responseObj = Response.Convert<StaffRespObj>(await _cacheService.GetCacheResponseAsync(CacheKeys.all_staff));
            if (responseObj != null)
                return responseObj;
        ...
        public async Task<ActivityRespObj> GetAllActivityAsync()
        {
            ...
            response = Response.Convert<ActivityRespObj>(await _cacheService.GetCacheResponseAsync(CacheKeys.all_activities));
            if (response != null)
                return response;
